# Comparing `tmp/nics-0.7.0.tar.gz` & `tmp/nics-0.8.0.tar.gz`
...
## Comparing `nics-0.7.0.tar` & `nics-0.8.0.tar`
...
### Comparing `nics-0.7.0/LICENSE` & `nics-0.8.0/LICENSE`

 * *Files identical despite different names*

### Comparing `nics-0.7.0/PKG-INFO` & `nics-0.8.0/PKG-INFO`
...
### Comparing `nics-0.7.0/nics/__init__.py` & `nics-0.8.0/nics/__init__.py`

 * *Files identical despite different names*

### Comparing `nics-0.7.0/nics.egg-info/PKG-INFO` & `nics-0.8.0/nics.egg-info/PKG-INFO`
...
### Comparing `nics-0.7.0/pyproject.toml` & `nics-0.8.0/pyproject.toml`
