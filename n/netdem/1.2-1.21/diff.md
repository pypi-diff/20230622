# Comparing `tmp/netdem-1.2-cp38-cp38-manylinux1_x86_64.whl.zip` & `tmp/netdem-1.21-cp38-cp38-manylinux1_x86_64.whl.zip`

## zipinfo {}

```diff
@@ -1,8 +1,8 @@
-Zip file size: 3962916 bytes, number of entries: 6
...
--rw-rw-r--  2.0 unx     1428 b- defN 23-Jun-22 16:35 netdem-1.2.dist-info/METADATA
--rw-rw-r--  2.0 unx      108 b- defN 23-Jun-22 16:35 netdem-1.2.dist-info/WHEEL
--rw-rw-r--  2.0 unx        7 b- defN 23-Jun-22 16:35 netdem-1.2.dist-info/top_level.txt
--rw-rw-r--  2.0 unx      467 b- defN 23-Jun-22 16:35 netdem-1.2.dist-info/RECORD
-6 files, 12732809 bytes uncompressed, 3962076 bytes compressed:  68.9%
