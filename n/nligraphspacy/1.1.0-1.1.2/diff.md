# Comparing `tmp/nligraphspacy-1.1.0.tar.gz` & `tmp/nligraphspacy-1.1.2.tar.gz`
...
## Comparing `nligraphspacy-1.1.0.tar` & `nligraphspacy-1.1.2.tar`
...
### Comparing `nligraphspacy-1.1.0/LICENSE` & `nligraphspacy-1.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `nligraphspacy-1.1.0/PKG-INFO` & `nligraphspacy-1.1.2/PKG-INFO`
...
### Comparing `nligraphspacy-1.1.0/nligraphspacy.egg-info/PKG-INFO` & `nligraphspacy-1.1.2/nligraphspacy.egg-info/PKG-INFO`
...
### Comparing `nligraphspacy-1.1.0/setup.py` & `nligraphspacy-1.1.2/setup.py`
