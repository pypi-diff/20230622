# Comparing `tmp/pyrefact-85.tar.gz` & `tmp/pyrefact-9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyrefact-85.tar", last modified: Thu Jun 22 19:38:20 2023, max compression
+gzip compressed data, was "pyrefact-9.tar", last modified: Wed Nov  2 20:30:27 2022, max compression
```

## Comparing `pyrefact-85.tar` & `pyrefact-9.tar`

### file list

```diff
@@ -1,33 +1,20 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-22 19:38:20.627062 pyrefact-85/
--rw-r--r--   0 runner    (1001) docker     (123)     1069 2023-06-22 19:38:05.000000 pyrefact-85/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     6550 2023-06-22 19:38:20.627062 pyrefact-85/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     4960 2023-06-22 19:38:05.000000 pyrefact-85/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      779 2023-06-22 19:38:05.000000 pyrefact-85/pyproject.toml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-22 19:38:20.627062 pyrefact-85/pyrefact/
--rw-r--r--   0 runner    (1001) docker     (123)       43 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/__init__.py
--rwxr-xr-x   0 runner    (1001) docker     (123)      127 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/__main__.py
--rw-r--r--   0 runner    (1001) docker     (123)    26568 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/abstractions.py
--rw-r--r--   0 runner    (1001) docker     (123)     6362 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/constants.py
--rw-r--r--   0 runner    (1001) docker     (123)   131226 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/fixes.py
--rw-r--r--   0 runner    (1001) docker     (123)      786 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/formatting.py
--rw-r--r--   0 runner    (1001) docker     (123)     1007 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/logs.py
--rwxr-xr-x   0 runner    (1001) docker     (123)    13502 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/main.py
--rw-r--r--   0 runner    (1001) docker     (123)     8263 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/object_oriented.py
--rw-r--r--   0 runner    (1001) docker     (123)    36019 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/parsing.py
--rw-r--r--   0 runner    (1001) docker     (123)    11847 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/performance.py
--rw-r--r--   0 runner    (1001) docker     (123)     4810 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/performance_numpy.py
--rw-r--r--   0 runner    (1001) docker     (123)     6871 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/performance_pandas.py
--rw-r--r--   0 runner    (1001) docker     (123)    16368 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/processing.py
--rw-r--r--   0 runner    (1001) docker     (123)     1615 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/style.py
--rw-r--r--   0 runner    (1001) docker     (123)    33697 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/symbolic_math.py
--rw-r--r--   0 runner    (1001) docker     (123)    18263 2023-06-22 19:38:05.000000 pyrefact-85/pyrefact/tracing.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-22 19:38:20.627062 pyrefact-85/pyrefact.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     6550 2023-06-22 19:38:20.000000 pyrefact-85/pyrefact.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      633 2023-06-22 19:38:20.000000 pyrefact-85/pyrefact.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-22 19:38:20.000000 pyrefact-85/pyrefact.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       52 2023-06-22 19:38:20.000000 pyrefact-85/pyrefact.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       98 2023-06-22 19:38:20.000000 pyrefact-85/pyrefact.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-06-22 19:38:20.000000 pyrefact-85/pyrefact.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-22 19:38:20.627062 pyrefact-85/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-22 19:38:20.627062 pyrefact-85/tests/
--rw-r--r--   0 runner    (1001) docker     (123)     2576 2023-06-22 19:38:05.000000 pyrefact-85/tests/testing_infra.py
...
### Comparing `pyrefact-85/LICENSE` & `pyrefact-9/LICENSE`

 * *Files identical despite different names*

### Comparing `pyrefact-85/pyrefact/symbolic_math.py` & `pyrefact-9/pyrefact/fixes.py`
