# Comparing `tmp/psat-server-web-0.1.6.tar.gz` & `tmp/psat-server-web-0.1.7.tar.gz`
...
--rw-r--r--   0 kws        (502) staff       (20)      808 2023-06-02 14:32:50.000000 psat-server-web-0.1.6/psat_server_web/schema/update_tcs_gravity_event_annotations_001.sql
--rw-r--r--   0 kws        (502) staff       (20)     1497 2021-11-23 00:25:03.000000 psat-server-web-0.1.6/psat_server_web/schema/update_tcs_latest_object_stats_001.sql
-drwxr-xr-x   0 kws        (502) staff       (20)        0 2023-06-21 21:59:06.442188 psat-server-web-0.1.6/psat_server_web.egg-info/
--rw-r--r--   0 kws        (502) staff       (20)      952 2023-06-21 21:58:59.000000 psat-server-web-0.1.6/psat_server_web.egg-info/PKG-INFO
--rw-r--r--   0 kws        (502) staff       (20)    22244 2023-06-21 21:59:06.000000 psat-server-web-0.1.6/psat_server_web.egg-info/SOURCES.txt
--rw-r--r--   0 kws        (502) staff       (20)        1 2023-06-21 21:58:59.000000 psat-server-web-0.1.6/psat_server_web.egg-info/dependency_links.txt
--rw-r--r--   0 kws        (502) staff       (20)        1 2023-04-17 21:29:34.000000 psat-server-web-0.1.6/psat_server_web.egg-info/not-zip-safe
--rw-r--r--   0 kws        (502) staff       (20)      115 2023-06-21 21:58:59.000000 psat-server-web-0.1.6/psat_server_web.egg-info/requires.txt
--rw-r--r--   0 kws        (502) staff       (20)       16 2023-06-21 21:58:59.000000 psat-server-web-0.1.6/psat_server_web.egg-info/top_level.txt
--rw-r--r--   0 kws        (502) staff       (20)       38 2023-06-21 21:59:06.824834 psat-server-web-0.1.6/setup.cfg
--rwxr-xr-x   0 kws        (502) staff       (20)     1238 2023-05-25 10:54:08.000000 psat-server-web-0.1.6/setup.py
...
### Comparing `psat-server-web-0.1.6/LICENSE` & `psat-server-web-0.1.7/LICENSE`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/PKG-INFO` & `psat-server-web-0.1.7/PKG-INFO`
...
### Comparing `psat-server-web-0.1.6/psat_server_web/.DS_Store` & `psat-server-web-0.1.7/psat_server_web/.DS_Store`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/.DS_Store` & `psat-server-web-0.1.7/psat_server_web/atlas/.DS_Store`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/commonqueries.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/commonqueries.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/dbviews.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/dbviews.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/formchoices.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/formchoices.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/helpers.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/helpers.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/lightcurvequeries.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/lightcurvequeries.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/models.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/models.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/settings.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/settings.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/sqlpaginator.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/sqlpaginator.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/urls.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/urls.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/views.py` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/views.py`
...
### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/wsgi.atlas.conf` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/wsgi.atlas.conf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/atlas/wsgi_apache_example.conf` & `psat-server-web-0.1.7/psat_server_web/atlas/atlas/wsgi_apache_example.conf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/generate_mod_wsgi_apachectl.sh` & `psat-server-web-0.1.7/psat_server_web/atlas/generate_mod_wsgi_apachectl.sh`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/css/aladin.css` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/css/aladin.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/css/celestial.css` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/css/celestial.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/css/fontawesome.css` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/css/fontawesome.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/css/main.css` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/css/main.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/css/main_bootstrap.css` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/css/main_bootstrap.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/images/atlas_logo.png` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/images/atlas_logo.png`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/images/image_not_available.jpeg` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/images/image_not_available.jpeg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/aladin.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/aladin.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/bootstrap_utils.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/bootstrap_utils.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/celestial.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/celestial.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/d3.geo.projection.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/d3.geo.projection.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/d3.geo.projection.min.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/d3.geo.projection.min.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/d3.geo.zoom.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/d3.geo.zoom.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/d3.min.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/d3.min.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/constellations.bounds.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/constellations.bounds.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/constellations.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/constellations.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/constellations.lines.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/constellations.lines.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/dsos.bright.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/dsos.bright.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/lg.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/lg.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/mw.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/mw.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/planets.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/planets.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/celestial/data/stars.6.json` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/celestial/data/stars.6.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/colourplot.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/colourplot.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/excanvas.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/excanvas.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery-1.7.2.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery-1.7.2.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.axislabels.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.axislabels.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.crosshair.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.crosshair.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.errorbars.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.errorbars.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.fillbetween.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.fillbetween.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.image.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.image.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.navigate.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.navigate.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.pie.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.pie.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.resize.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.resize.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.selection.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.selection.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.stack.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.stack.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.symbol.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.symbol.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/flot/jquery.flot.threshold.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/flot/jquery.flot.threshold.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/followup_selectall.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/followup_selectall.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/heatmap.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/heatmap.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/lightcurve.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/lightcurve.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/lightcurveplotly.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/lightcurveplotly.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/mjdcalc.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/mjdcalc.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/plotly/plotly-latest.kws.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/plotly/plotly-latest.kws.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/recurrenceplot.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/recurrenceplot.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/js/recurrenceplotplotly.js` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/js/recurrenceplotplotly.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-brands-400.eot` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-brands-400.eot`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-brands-400.svg` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-brands-400.svg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-brands-400.ttf` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-brands-400.ttf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-brands-400.woff` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-brands-400.woff`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-brands-400.woff2` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-brands-400.woff2`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-regular-400.eot` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-regular-400.eot`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-regular-400.svg` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-regular-400.svg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-regular-400.ttf` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-regular-400.ttf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-regular-400.woff` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-regular-400.woff`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-regular-400.woff2` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-regular-400.woff2`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-solid-900.eot` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-solid-900.eot`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-solid-900.svg` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-solid-900.svg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-solid-900.ttf` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-solid-900.ttf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-solid-900.woff` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-solid-900.woff`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/site_media/webfonts/fa-solid-900.woff2` & `psat-server-web-0.1.7/psat_server_web/atlas/site_media/webfonts/fa-solid-900.woff2`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/sql/create_web_views.sql` & `psat-server-web-0.1.7/psat_server_web/atlas/sql/create_web_views.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/.DS_Store` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/.DS_Store`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/atelfasttrackobject.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/atelfasttrackobject.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/atelsdiscovery.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/atelsdiscovery.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/atelsfast.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/atelsfast.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/candidate.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/candidate.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/candidate_plotly.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/candidate_plotly.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/candidate_plotly_test.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/candidate_plotly_test.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/crossmatch_external.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/crossmatch_external.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup2.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup2.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup_bs.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup_bs.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup_bypass_django_tables.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup_bypass_django_tables.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup_quickview.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup_quickview.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup_quickview_bs.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup_quickview_bs.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/followup_subset.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/followup_subset.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/gcn.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/gcn.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/gcn_latex.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/gcn_latex.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/heatmap.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/heatmap.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/heatmap_test.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/heatmap_test.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/index.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/index.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/index_bs.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/index_bs.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/index_bs_celestial.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/index_bs_celestial.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/lightcurve.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/lightcurve.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/lightcurveddc.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/lightcurveddc.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/lightcurveforced.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/lightcurveforced.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/pesstosummary.txt` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/pesstosummary.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/search_results.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/search_results.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/search_results_plotly.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/search_results_plotly.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/summary.csv` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/summary.csv`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/userdefinedlists.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/userdefinedlists.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/atlas/userdefinedlists_bs.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/atlas/userdefinedlists_bs.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/base.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/base.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/base_bootstrap.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/base_bootstrap.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/base_bootstrap_login.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/base_bootstrap_login.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/bootstrap4_django_tables2_atlas.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/bootstrap4_django_tables2_atlas.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/templates/login.html` & `psat-server-web-0.1.7/psat_server_web/atlas/templates/login.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/atlas/test.py` & `psat-server-web-0.1.7/psat_server_web/atlas/test.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/config/wsgi.conf.template` & `psat-server-web-0.1.7/psat_server_web/config/wsgi.conf.template`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/createUsers.py` & `psat-server-web-0.1.7/psat_server_web/ps1/createUsers.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/generate_mod_wsgi_apachectl.sh` & `psat-server-web-0.1.7/psat_server_web/ps1/generate_mod_wsgi_apachectl.sh`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/admin.py.old` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/admin.py.old`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/catalogueviews.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/catalogueviews.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/commonqueries.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/commonqueries.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/dbviews.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/dbviews.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/formchoices.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/formchoices.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/helpers.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/helpers.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/img_scale.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/img_scale.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/lightcurvequeries.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/lightcurvequeries.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/models.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/models.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/settings.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/settings.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/urls.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/urls.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/views.py` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/views.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/psdb/wsgi_apache_example.conf` & `psat-server-web-0.1.7/psat_server_web/ps1/psdb/wsgi_apache_example.conf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/css/aladin.css` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/css/aladin.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/css/celestial.css` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/css/celestial.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/css/fontawesome.css` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/css/fontawesome.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/css/main.css` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/css/main.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/css/main_bootstrap.css` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/css/main_bootstrap.css`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/1-star-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/1-star-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/1-star.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/1-star.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/2-star-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/2-star-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/2-star.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/2-star.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/3-star-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/3-star-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/3-star.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/3-star.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/aladin.gif` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/aladin.gif`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/cfaIcon.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/cfaIcon.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/cfaIconHover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/cfaIconHover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/confirmed-sne-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/confirmed-sne-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/confirmed-sne.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/confirmed-sne.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/detection_example.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/detection_example.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/down.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/down.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/image_not_available.jpeg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/image_not_available.jpeg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/jhuIcon.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/jhuIcon.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/jhuIconHover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/jhuIconHover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/minus.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/minus.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/ncuIcon.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/ncuIcon.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/ncuIconHover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/ncuIconHover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/non_detection_example.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/non_detection_example.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/others-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/others-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/others.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/others.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs-logo-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs-logo-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs-logo.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs-logo.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs1_logo.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs1_logo.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs1_o3_logo.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs1_o3_logo.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs2_logo.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs2_logo.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs2_o3_logo.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs2_o3_logo.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs_logo.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs_logo.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs_logo_original.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs_logo_original.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs_logo_yse.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs_logo_yse.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/panstarrs_logo_yse_stack.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/panstarrs_logo_yse_stack.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/pittsIcon.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/pittsIcon.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/pittsIconHover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/pittsIconHover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/plus.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/plus.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/ps1Icon.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/ps1Icon.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/ps1IconHover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/ps1IconHover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/ps1sc.gif` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/ps1sc.gif`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/qub-logo-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/qub-logo-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/qub-logo.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/qub-logo.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/qubIcon.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/qubIcon.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/qubIconHover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/qubIconHover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/sdss.gif` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/sdss.gif`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/table-background.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/table-background.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/table-bottom-left.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/table-bottom-left.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/table-bottom-right.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/table-bottom-right.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/table-row.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/table-row.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/table-top-left.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/table-top-left.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/table-top-right.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/table-top-right.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/uhifaIcon.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/uhifaIcon.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/uhifaIconHover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/uhifaIconHover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/up.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/up.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/variable-stars-hover.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/variable-stars-hover.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/images/variable-stars.jpg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/images/variable-stars.jpg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/aladin.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/aladin.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/celestial.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/celestial.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/d3.geo.projection.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/d3.geo.projection.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/d3.geo.projection.min.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/d3.geo.projection.min.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/d3.geo.zoom.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/d3.geo.zoom.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/d3.min.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/d3.min.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/constellations.bounds.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/constellations.bounds.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/constellations.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/constellations.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/constellations.lines.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/constellations.lines.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/dsos.bright.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/dsos.bright.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/lg.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/lg.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/mw.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/mw.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/planets.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/planets.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/celestial/data/stars.6.json` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/celestial/data/stars.6.json`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/colourplot.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/colourplot.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/excanvas.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/excanvas.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery-1.7.2.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery-1.7.2.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.axislabels.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.axislabels.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.crosshair.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.crosshair.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.errorbars.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.errorbars.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.fillbetween.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.fillbetween.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.image.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.image.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.navigate.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.navigate.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.pie.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.pie.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.resize.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.resize.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.selection.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.selection.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.stack.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.stack.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.symbol.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.symbol.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/flot/jquery.flot.threshold.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/flot/jquery.flot.threshold.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/followup_selectall.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/followup_selectall.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/lightcurve.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/lightcurve.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/lightcurveplotly.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/lightcurveplotly.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/mjdcalc.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/mjdcalc.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/plotly/plotly-latest.kws.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/plotly/plotly-latest.kws.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/recurrenceplot.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/recurrenceplot.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/js/recurrenceplotplotly.js` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/js/recurrenceplotplotly.js`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-brands-400.eot` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-brands-400.eot`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-brands-400.svg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-brands-400.svg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-brands-400.ttf` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-brands-400.ttf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-brands-400.woff` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-brands-400.woff`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-brands-400.woff2` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-brands-400.woff2`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-regular-400.eot` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-regular-400.eot`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-regular-400.svg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-regular-400.svg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-regular-400.ttf` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-regular-400.ttf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-regular-400.woff` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-regular-400.woff`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-regular-400.woff2` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-regular-400.woff2`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-solid-900.eot` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-solid-900.eot`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-solid-900.svg` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-solid-900.svg`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-solid-900.ttf` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-solid-900.ttf`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-solid-900.woff` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-solid-900.woff`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/site_media/webfonts/fa-solid-900.woff2` & `psat-server-web-0.1.7/psat_server_web/ps1/site_media/webfonts/fa-solid-900.woff2`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/sql/create_web_cat_views.sql` & `psat-server-web-0.1.7/psat_server_web/ps1/sql/create_web_cat_views.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/sql/create_web_user_grants.sql` & `psat-server-web-0.1.7/psat_server_web/ps1/sql/create_web_user_grants.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/sql/create_web_views.sql` & `psat-server-web-0.1.7/psat_server_web/ps1/sql/create_web_views.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/sql/create_web_views_fgss.sql` & `psat-server-web-0.1.7/psat_server_web/ps1/sql/create_web_views_fgss.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/base.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/base.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/base_bootstrap.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/base_bootstrap.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/base_bootstrap_login.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/base_bootstrap_login.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/base_new.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/base_new.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/bootstrap4_django_tables2_atlas.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/bootstrap4_django_tables2_atlas.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/login.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/login.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/atelsdiscovery.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/atelsdiscovery.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/candidate.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/candidate.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/candidate_plotly.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/candidate_plotly.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/candidate_quickview.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/candidate_quickview.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/candidateflot.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/candidateflot.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/candidates.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/candidates.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/colourdata.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/colourdata.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/crossmatch_cfa_with_ipp.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/crossmatch_cfa_with_ipp.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/crossmatch_external.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/crossmatch_external.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/fasttrackastronote.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/fasttrackastronote.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/filter.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/filter.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/followup.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/followup.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/followup.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/followup.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/followup_bs.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/followup_bs.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/followup_bs_old.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/followup_bs_old.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/followup_quickview.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/followup_quickview.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/followup_quickview_bs.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/followup_quickview_bs.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/followup_quickview_bs_old.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/followup_quickview_bs_old.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/gcn.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/gcn.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/gcn_latex.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/gcn_latex.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/index.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/index.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/index_bs_celestial.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/index_bs_celestial.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/index_public.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/index_public.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/lightcurves.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/lightcurves.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/obsmediawiki.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/obsmediawiki.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/public.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/public.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/public_textonly.txt` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/public_textonly.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/reports.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/reports.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/search_results.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/search_results.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/search_results_plotly.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/search_results_plotly.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/userdefinedlists.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/userdefinedlists.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/ps1/templates/psdb/userdefinedlists_bs.html` & `psat-server-web-0.1.7/psat_server_web/ps1/templates/psdb/userdefinedlists_bs.html`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_detections.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_detections.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_detectionsddc.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_detectionsddc.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_diff_detections.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_diff_detections.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_diff_logs.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_diff_logs.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_diff_moments.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_diff_moments.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_diff_objects.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_diff_objects.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_diff_subcell_logs.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_diff_subcell_logs.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_diff_subcells.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_diff_subcells.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_forced_photometry.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_forced_photometry.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_heatmaps.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_heatmaps.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_metadata.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_metadata.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_metadataddc.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_metadataddc.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_objects.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_objects.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/atlas_stacked_forced_photometry.sql` & `psat-server-web-0.1.7/psat_server_web/schema/atlas_stacked_forced_photometry.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/convert_backend_storage_to_innodb.sql` & `psat-server-web-0.1.7/psat_server_web/schema/convert_backend_storage_to_innodb.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/create_atlas_flattened_view.sql` & `psat-server-web-0.1.7/psat_server_web/schema/create_atlas_flattened_view.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/create_photpipe_views.sql` & `psat-server-web-0.1.7/psat_server_web/schema/create_photpipe_views.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/create_schema.sql` & `psat-server-web-0.1.7/psat_server_web/schema/create_schema.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/create_user_grants.sql` & `psat-server-web-0.1.7/psat_server_web/schema/create_user_grants.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/create_user_grants_generic.sql` & `psat-server-web-0.1.7/psat_server_web/schema/create_user_grants_generic.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/delete_transients.sql` & `psat-server-web-0.1.7/psat_server_web/schema/delete_transients.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/generateATLASSchemaAndCPPClasses.py` & `psat-server-web-0.1.7/psat_server_web/schema/generateATLASSchemaAndCPPClasses.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/get_table_columns_for_avro.py` & `psat-server-web-0.1.7/psat_server_web/schema/get_table_columns_for_avro.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/refresh_django_views.py` & `psat-server-web-0.1.7/psat_server_web/schema/refresh_django_views.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/setup_database.py` & `psat-server-web-0.1.7/psat_server_web/schema/setup_database.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/setup_database_utils.py` & `psat-server-web-0.1.7/psat_server_web/schema/setup_database_utils.py`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/sherlock_classifications.sql` & `psat-server-web-0.1.7/psat_server_web/schema/sherlock_classifications.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/sherlock_crossmatches.sql` & `psat-server-web-0.1.7/psat_server_web/schema/sherlock_crossmatches.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_gaia_dr1.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_gaia_dr1.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_gaia_dr2.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_gaia_dr2.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_gaia_dr2_cassandra.cql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_gaia_dr2_cassandra.cql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_kepler_k2.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_kepler_k2.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_kepler_k2_pixels.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_kepler_k2_pixels.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_ps1_medium_deep_ref.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_ps1_medium_deep_ref.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_ps1_ubercal_stars.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_ps1_ubercal_stars.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cat_satellites.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cat_satellites.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_catalogue_tables.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_catalogue_tables.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cfa_detections.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cfa_detections.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cfa_to_ipp_lookup.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cfa_to_ipp_lookup.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_classification_flags.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_classification_flags.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_classification_history.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_classification_history.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cmf_metadata.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cmf_metadata.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cross_matches.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cross_matches.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_cross_matches_external.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_cross_matches_external.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_detection_lists.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_detection_lists.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_detection_lists_atlas.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_detection_lists_atlas.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_followup_photometry.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_followup_photometry.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_followup_telescope_instruments.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_followup_telescope_instruments.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_followup_telescopes.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_followup_telescopes.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_forced_photometry.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_forced_photometry.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_function_lunation.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_function_lunation.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_function_mjdlunation.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_function_mjdlunation.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_gravity_alerts.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_gravity_alerts.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_gravity_event_annotations.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_gravity_event_annotations.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_gravity_events.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_gravity_events.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_guide_star_cat.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_guide_star_cat.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_image_groups.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_image_groups.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_images.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_images.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_ipp_to_cfa_lookup.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_ipp_to_cfa_lookup.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_latest_object_stats.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_latest_object_stats.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_object_comments.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_object_comments.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_object_group_definitions.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_object_group_definitions.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_object_group_definitions_atlas.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_object_group_definitions_atlas.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_object_groups.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_object_groups.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_parameter_definitions.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_parameter_definitions.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_photpipe_detections.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_photpipe_detections.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_postage_stamp_images.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_postage_stamp_images.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_postage_stamp_requests.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_postage_stamp_requests.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_postage_stamp_status_codes.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_postage_stamp_status_codes.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_processing_status.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_processing_status.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_search_parameters.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_search_parameters.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_tns_requests.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_tns_requests.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_tphot_detections.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_tphot_detections.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_transient_objects.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_transient_objects.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_transient_reobservations.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_transient_reobservations.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_zoo_requests.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_zoo_requests.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/tcs_zooniverse_scores.sql` & `psat-server-web-0.1.7/psat_server_web/schema/tcs_zooniverse_scores.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/types_gaia_dr2_cassandra.txt` & `psat-server-web-0.1.7/psat_server_web/schema/types_gaia_dr2_cassandra.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/update_database_types_to_tns_types_atlas.sql` & `psat-server-web-0.1.7/psat_server_web/schema/update_database_types_to_tns_types_atlas.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/update_database_types_to_tns_types_panstarrs.sql` & `psat-server-web-0.1.7/psat_server_web/schema/update_database_types_to_tns_types_panstarrs.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/update_tcs_gravity_event_annotations_001.sql` & `psat-server-web-0.1.7/psat_server_web/schema/update_tcs_gravity_event_annotations_001.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web/schema/update_tcs_latest_object_stats_001.sql` & `psat-server-web-0.1.7/psat_server_web/schema/update_tcs_latest_object_stats_001.sql`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/psat_server_web.egg-info/PKG-INFO` & `psat-server-web-0.1.7/psat_server_web.egg-info/PKG-INFO`
...
### Comparing `psat-server-web-0.1.6/psat_server_web.egg-info/SOURCES.txt` & `psat-server-web-0.1.7/psat_server_web.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `psat-server-web-0.1.6/setup.py` & `psat-server-web-0.1.7/setup.py`
