# Comparing `tmp/veetility-0.1.89.tar.gz` & `tmp/veetility-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "veetility-0.1.89.tar", last modified: Thu Jun 22 11:20:09 2023, max compression
+gzip compressed data, was "veetility-0.1.9.tar", last modified: Fri Jan 27 12:16:41 2023, max compression
```

## Comparing `veetility-0.1.89.tar` & `veetility-0.1.9.tar`

### file list

```diff
@@ -1,25 +1,14 @@
-drwxr-xr-x   0 willbutler   (502) staff       (20)        0 2023-06-22 11:20:09.652870 veetility-0.1.89/
--rw-r--r--   0 willbutler   (502) staff       (20)     3538 2023-06-22 11:20:09.652715 veetility-0.1.89/PKG-INFO
--rw-r--r--   0 willbutler   (502) staff       (20)     2881 2023-02-28 17:30:34.000000 veetility-0.1.89/README.md
--rw-r--r--   0 willbutler   (502) staff       (20)       38 2023-06-22 11:20:09.652925 veetility-0.1.89/setup.cfg
--rw-r--r--   0 willbutler   (502) staff       (20)     1438 2023-06-22 11:19:59.000000 veetility-0.1.89/setup.py
-drwxr-xr-x   0 willbutler   (502) staff       (20)        0 2023-06-22 11:20:09.646323 veetility-0.1.89/tests/
--rw-r--r--   0 willbutler   (502) staff       (20)     1892 2023-04-09 19:51:45.000000 veetility-0.1.89/tests/test_best_fuzzy_match_dict.py
--rw-r--r--   0 willbutler   (502) staff       (20)     2471 2023-04-09 19:42:01.000000 veetility-0.1.89/tests/test_identify_match_multi_cols.py
--rw-r--r--   0 willbutler   (502) staff       (20)     1588 2023-04-09 18:45:40.000000 veetility-0.1.89/tests/test_prepare_string_matching.py
-drwxr-xr-x   0 willbutler   (502) staff       (20)        0 2023-06-22 11:20:09.650554 veetility-0.1.89/veetility/
--rw-r--r--   0 willbutler   (502) staff       (20)        0 2023-02-28 17:30:34.000000 veetility-0.1.89/veetility/__init__.py
--rw-r--r--   0 willbutler   (502) staff       (20)    17689 2023-06-12 11:29:12.000000 veetility-0.1.89/veetility/cleaning_functions.py
--rw-r--r--   0 willbutler   (502) staff       (20)     7088 2023-05-23 14:51:46.000000 veetility-0.1.89/veetility/generic_functions.py
--rw-r--r--   0 willbutler   (502) staff       (20)     2465 2023-03-03 12:20:14.000000 veetility-0.1.89/veetility/point_to_point_regressor.py
--rw-r--r--   0 willbutler   (502) staff       (20)    30397 2023-06-22 11:19:39.000000 veetility-0.1.89/veetility/quality_assessments.py
--rw-r--r--   0 willbutler   (502) staff       (20)    11585 2023-05-23 16:42:13.000000 veetility-0.1.89/veetility/snowflake.py
--rw-r--r--   0 willbutler   (502) staff       (20)    53597 2023-06-12 19:20:06.000000 veetility-0.1.89/veetility/utility_functions.py
--rw-r--r--   0 willbutler   (502) staff       (20)     2411 2023-05-05 13:50:17.000000 veetility-0.1.89/veetility/v_lift.py
--rw-r--r--   0 willbutler   (502) staff       (20)     6007 2023-06-12 15:35:11.000000 veetility-0.1.89/veetility/view_through_rate.py
-drwxr-xr-x   0 willbutler   (502) staff       (20)        0 2023-06-22 11:20:09.652494 veetility-0.1.89/veetility.egg-info/
--rw-r--r--   0 willbutler   (502) staff       (20)     3538 2023-06-22 11:20:09.000000 veetility-0.1.89/veetility.egg-info/PKG-INFO
--rw-r--r--   0 willbutler   (502) staff       (20)      557 2023-06-22 11:20:09.000000 veetility-0.1.89/veetility.egg-info/SOURCES.txt
--rw-r--r--   0 willbutler   (502) staff       (20)        1 2023-06-22 11:20:09.000000 veetility-0.1.89/veetility.egg-info/dependency_links.txt
--rw-r--r--   0 willbutler   (502) staff       (20)       97 2023-06-22 11:20:09.000000 veetility-0.1.89/veetility.egg-info/requires.txt
--rw-r--r--   0 willbutler   (502) staff       (20)       10 2023-06-22 11:20:09.000000 veetility-0.1.89/veetility.egg-info/top_level.txt
...
### Comparing `veetility-0.1.89/setup.py` & `veetility-0.1.9/setup.py`
...
### Comparing `veetility-0.1.89/veetility/quality_assessments.py` & `veetility-0.1.9/veetility/utility_functions.py`
