# Comparing `tmp/vnstock-0.1.4.tar.gz` & `tmp/vnstock-0.1.6.tar.gz`
...
## Comparing `vnstock-0.1.4.tar` & `vnstock-0.1.6.tar`
...
### Comparing `vnstock-0.1.4/LICENSE` & `vnstock-0.1.6/LICENSE`

 * *Files identical despite different names*

### Comparing `vnstock-0.1.4/vnstock/stock.py` & `vnstock-0.1.6/vnstock/stock.py`
