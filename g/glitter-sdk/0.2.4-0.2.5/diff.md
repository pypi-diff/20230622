# Comparing `tmp/glitter_sdk-0.2.4.tar.gz` & `tmp/glitter_sdk-0.2.5.tar.gz`
...
### Comparing `glitter_sdk-0.2.4/glitter_sdk/core/multisig.py` & `glitter_sdk-0.2.5/glitter_sdk/core/multisig.py`
