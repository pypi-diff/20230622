# Comparing `tmp/gaitmap-2.2.1.tar.gz` & `tmp/gaitmap-2.2.2.tar.gz`
...
### Comparing `gaitmap-2.2.1/gaitmap/stride_segmentation/__init__.py` & `gaitmap-2.2.2/gaitmap/stride_segmentation/__init__.py`
