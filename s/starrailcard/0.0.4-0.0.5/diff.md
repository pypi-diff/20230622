# Comparing `tmp/starrailcard-0.0.4.tar.gz` & `tmp/starrailcard-0.0.5.tar.gz`
...
### Comparing `starrailcard-0.0.4/starrailcard/src/tools/modal.py` & `starrailcard-0.0.5/starrailcard/src/tools/modal.py`
