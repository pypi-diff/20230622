# Comparing `tmp/spoutlang-0.2.1.tar.gz` & `tmp/spoutlang-0.2.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "spoutlang-0.2.1.tar", last modified: Thu Jun 22 13:35:44 2023, max compression
+gzip compressed data, was "spoutlang-0.2.2.tar", last modified: Thu Jun 22 13:47:09 2023, max compression
```

## Comparing `spoutlang-0.2.1.tar` & `spoutlang-0.2.2.tar`

### file list

```diff
@@ -1,12 +1,20 @@
-drwxr-xr-x   0 tapu      (1000) tapu      (1000)        0 2023-06-22 13:35:44.404290 spoutlang-0.2.1/
--rw-r--r--   0 tapu      (1000) tapu      (1000)      421 2023-06-22 13:35:44.398783 spoutlang-0.2.1/PKG-INFO
--rw-r--r--   0 tapu      (1000) tapu      (1000)      258 2023-05-24 10:18:07.000000 spoutlang-0.2.1/README.md
--rw-r--r--   0 tapu      (1000) tapu      (1000)     1280 2023-06-22 12:12:43.000000 spoutlang-0.2.1/main.py
--rw-r--r--   0 tapu      (1000) tapu      (1000)       38 2023-06-22 13:35:44.405284 spoutlang-0.2.1/setup.cfg
--rw-r--r--   0 tapu      (1000) tapu      (1000)      703 2023-06-22 13:35:40.000000 spoutlang-0.2.1/setup.py
-drwxr-xr-x   0 tapu      (1000) tapu      (1000)        0 2023-06-22 13:35:44.393622 spoutlang-0.2.1/spoutlang.egg-info/
--rw-r--r--   0 tapu      (1000) tapu      (1000)      421 2023-06-22 13:35:44.000000 spoutlang-0.2.1/spoutlang.egg-info/PKG-INFO
--rw-r--r--   0 tapu      (1000) tapu      (1000)      194 2023-06-22 13:35:44.000000 spoutlang-0.2.1/spoutlang.egg-info/SOURCES.txt
--rw-r--r--   0 tapu      (1000) tapu      (1000)        1 2023-06-22 13:35:44.000000 spoutlang-0.2.1/spoutlang.egg-info/dependency_links.txt
--rw-r--r--   0 tapu      (1000) tapu      (1000)       55 2023-06-22 13:35:44.000000 spoutlang-0.2.1/spoutlang.egg-info/entry_points.txt
--rw-r--r--   0 tapu      (1000) tapu      (1000)       11 2023-06-22 13:35:44.000000 spoutlang-0.2.1/spoutlang.egg-info/top_level.txt
...
### Comparing `spoutlang-0.2.1/main.py` & `spoutlang-0.2.2/main.py`

 * *Files identical despite different names*

### Comparing `spoutlang-0.2.1/setup.py` & `spoutlang-0.2.2/setup.py`
